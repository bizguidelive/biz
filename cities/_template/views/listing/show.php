...
<div>
  <div class="l-hero">
    ...
    <img src="<?= BASE_URL ?>/assets/uploads/listings/<?= htmlspecialchars($listing["top_banner"]) ?>" class="l-banner" alt="<?= htmlspecialchars($listing["business_name"]) ?>">
    <?php elseif(!empty($images) && in_array($listing["plan_level"],["premium","pro"])): ?>
    <img src="<?= BASE_URL ?>/assets/uploads/listings/<?= htmlspecialchars($images[0]["filename"]) ?>" class="l-banner" alt="<?= htmlspecialchars($listing["business_name"]) ?>">
    <?php endif ?>
